...
function NavBar() {
    return (
        <div className="flex flex-row w-screen">
            <button className="bg-blue-800 hover:text-slate-400 transition-all cursor-pointer w-1/8 border-r-2 border-slate-700 py-4 flex flex-row gap-2 justify-center text-center outline-0 border-0">
                <Menu className="text-white" />
                <p className="text-white">Todas as categorias</p>
            </button>
            <nav className="bg-blue-700 w-full font-light text-lg items-center px-8 text-white flex flex-row gap-8">
